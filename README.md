...
## Table of Contents
 ...
 2) [Camera Models](docs/CAMERA_MODELS.md)
 3) [Calibration Targets](docs/CALIBRATION_TARGETS.md)
 4) [Algorithm Overview](docs/ALGORITHM_OVERVIEW.md)
...
![Cornell box + checkerboard target demo render](docs/media/cornell_box_checkerboard_render.png)
...
![Synthetic calibration dataset renders](docs/media/synthetic_calibration_dataset_image_grid.png)
...
![Synthetic calibration dataset camera poses](docs/media/synthetic_calibration_dataset_poses.png)
